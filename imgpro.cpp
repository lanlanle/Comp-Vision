...
int main(int argc, char **argv)
{
  ...
  for (int i = 0; i < argc; i++) {
    ...
    //change this into your own input and output

		char inputName[100] = "/Users/lanle/Downloads/skeletonv2/src/sky_input1/%07d.jpg";
		char outputName[100] = "/Users/lanle/Downloads/skeletonv2/src/sky_output1/%07d.jpg";
    ...
    sprintf(currentOutputFilename,outputName,1);
		...
		// mainImage->Blur(3.0f);
		//here you could call 
    R2Image previousImage(*mainImage);
    ...
    // write result to file
      if (!mainImage->Write(currentOutputFilename)) {
		...
		int end = 96; //change it to the size of your photo 
		for (int i = 2; i < end; i++)
		{
      ...
      R2Image tempImage(*currentImage);

			//currentImage->Brighten((float)i/(float)end);
			// here you could call 
			// 
  			previousImage.FrameProcessing( currentImage ); 
